...
- [ ] Operator populated GitHub Actions secrets: `VITE_SENTRY_DSN`, `SENTRY_AUTH_TOKEN`, `SENTRY_ORG`, `SENTRY_PROJECT`, `SENTRY_RELEASE` (and `VITE_SENTRY_RELEASE`) for the frontend build
