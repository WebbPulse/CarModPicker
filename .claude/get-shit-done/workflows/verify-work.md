...
Read and follow `/home/tyler-webb/Documents/Github/CarModPicker/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/home/tyler-webb/Documents/Github/CarModPicker/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/home/tyler-webb/Documents/Github/CarModPicker/.claude/get-shit-done/workflows/diagnose-issues.md
