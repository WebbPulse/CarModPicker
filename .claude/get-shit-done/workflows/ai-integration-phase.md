...
```markdown
Read /Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/agents/gsd-eval-planner.md for instructions.
