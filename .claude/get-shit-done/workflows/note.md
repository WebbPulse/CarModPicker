...
- **Global scope**: `/home/tyler-webb/Documents/Github/CarModPicker/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/tyler-webb/Documents/Github/CarModPicker/.claude/notes/`)
...
2. Glob `/home/tyler-webb/Documents/Github/CarModPicker/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/tyler-webb/Documents/Github/CarModPicker/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/tyler-webb/Documents/Github/CarModPicker/.claude/notes/` — works in any directory
