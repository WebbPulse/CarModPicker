...
- **Global scope**: `/Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/notes/`)
...
2. Glob `/Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tyler.webb/Documents/GitHub/Personal Projects/CarModPicker/.claude/notes/` — works in any directory
