...
```bash
INIT=$(node "/home/tyler-webb/Documents/Github/CarModPicker/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/tyler-webb/Documents/Github/CarModPicker/.claude/get-shit-done/templates/spec.md.
