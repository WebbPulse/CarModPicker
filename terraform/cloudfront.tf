# BLOCKED: requires aws_acm_certificate_validation.carmodpicker (cert PENDING_VALIDATION).
# Uncomment this entire file once the ACM certificate is ISSUED and the domain is delegated
# to Route53 NS servers (ns-517.awsdns-00.net, ns-1696.awsdns-20.co.uk,
# ns-1477.awsdns-56.org, ns-257.awsdns-32.com).
