...
# ---------------------------------------------------------------------------
# App Runner Service
# BLOCKED: ECR repository is empty — push a Docker image first, then uncomment.
# After uncommenting and applying, also uncomment aws_route53_record.api in
# route53.tf and aws_apprunner_custom_domain_association below.
# ---------------------------------------------------------------------------
...
# BLOCKED: depends on aws_apprunner_service.backend above.
