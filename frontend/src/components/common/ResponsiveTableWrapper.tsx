...
const ResponsiveTableWrapper = (
    { ref, visibleColumns, columnMinWidths, totalMinWidth, tableClassName = 'w-full text-sm table-fixed', children }: ResponsiveTableWrapperProps & { ref?: React.RefObject<HTMLDivElement | null> }
  ) => (
