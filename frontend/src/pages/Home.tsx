    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 px-4">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-primary-400/10 rounded-full blur-3xl animate-float"
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16 animate-slideInUp">
            ...
            <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
              Powerful tools and features to help you plan, build, and share
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto animate-slideInUp">
            ...
            <p className="text-xl text-neutral-400 mb-8">
              Join the community and start creating amazing car modifications
              today
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {isAuthenticated ? (
