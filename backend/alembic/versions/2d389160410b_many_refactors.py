...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['global_part_id'], ['global_parts.id'], ),
    ...
    op.create_table('part_price_history',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('part_listing_id', sa.Integer(), nullable=False),
    sa.Column('price_cents', sa.Integer(), nullable=False),
    sa.Column('observed_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['part_listing_id'], ['part_listings.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_part_price_history_part_listing_id'), 'part_price_history', ['part_listing_id'], unique=False)
