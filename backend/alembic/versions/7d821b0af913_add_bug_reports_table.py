...
def upgrade() -> None:
    ...
    op.alter_column("build_log_posts", "user_id", existing_type=sa.INTEGER(), nullable=True)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("build_log_posts", "user_id", existing_type=sa.INTEGER(), nullable=False)
