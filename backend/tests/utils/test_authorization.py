...
class TestAuthorization:
    ...
    def test_can_delete_global_part_owner(self, test_user: User) -> None:
    ...
    def test_can_delete_global_part_admin(self, test_user: User) -> None:
    ...
    def test_can_delete_global_part_unauthorized(self, test_user: User) -> None:
    ...
    def test_can_edit_global_part_owner(self, test_user: User) -> None:
    ...
    def test_can_edit_global_part_admin(self, test_user: User) -> None:
    ...
    def test_require_global_part_delete_permission_raises(self, test_user: User) -> None:
        """Test that require_global_part_delete_permission raises when unauthorized."""
        from app.api.dependencies.auth import get_password_hash
        ...
        try:
            require_global_part_delete_permission(other_user, global_part)
            assert False, "Should have raised HTTPException"
        except HTTPException as e:
            assert e.status_code == 403

    def test_require_global_part_edit_permission_raises(self, test_user: User) -> None:
        """Test that require_global_part_edit_permission raises when unauthorized."""
        from app.api.dependencies.auth import get_password_hash
        ...
        try:
            require_global_part_edit_permission(other_user, global_part)
            assert False, "Should have raised HTTPException"
        except HTTPException as e:
            assert e.status_code == 403
