...
from app.common.db.dynamo.catalog import Category, PartManufacturer
...
def _drain_part_purge(repos: Any, part_id: UUID) -> None:
    ...
    from app.domains.catalog.consumers.part_purge import purge_related_rows
...
def _drain_user_delete(repos: Any, user_id: UUID) -> None:
    ...
    """
    from app.domains.users.consumers.user_delete import cascade_user_delete
