...
from app.common.db.dynamo.build_logs import BuildLog, BuildLogPost, BuildLogPostRepository, BuildLogRepository
from app.common.db.dynamo.catalog import Category, PartManufacturer, PartRepository
from app.common.db.dynamo.moderation import Report, ReportRepository, Vote, VoteRepository
...
class TestModerationTreatsTombstonesAsAbsent:
    ...
    def test_flagged_listing_skips_tombstoned_parts(
        ...
        from app.common.api.services.vote_service import EntityType, VoteService
