...
SCRIPT_PATH = Path(__file__).resolve().parents[2] / "scripts" / "generate_ext_api_contract.py"
CONTRACT_PATH = Path(__file__).resolve().parents[3] / "chrome-extension" / "API_CONTRACT.md"
