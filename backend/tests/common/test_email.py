...
from app.common.core.email import send_reset_password_email, send_verify_email  # noqa: E402


class TestEmailService:
    """Test cases for the SES-based email service."""

    @patch("app.common.core.email.settings")
    @patch("app.common.core.email.boto3.client")
    ...
    def test_verify_email_template_contains_placeholder(self) -> None:
        ...
        from app.common.core.email import _TEMPLATES_DIR
