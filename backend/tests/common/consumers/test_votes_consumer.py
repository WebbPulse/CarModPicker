...
from app.common.db.dynamo.catalog import Category, CategoryRepository, Part, PartRepository
from app.common.db.dynamo.moderation import Vote, VoteRepository
from app.common.db.dynamo.repository import ItemNotFound
from app.domains.catalog.consumers.votes import (
...
class TestEntrypoint:
    ...
    def client(
        ...
        from app.domains.catalog.consumers import votes_entrypoint as entrypoint
    ...
    def test_the_bundle_is_memoised_across_invokes(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr("app.common.composition.wiring.bundle_for", fake_bundle_for)
