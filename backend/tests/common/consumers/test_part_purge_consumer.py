...
from app.domains.catalog.consumers.part_purge import (
    MESSAGE_KIND,
    MESSAGE_VERSION,
...
class TestAgainstRealRepositories:
    ...
    def test_the_cascade_removes_every_referencing_row(self, dynamo_tables: Any) -> None:
        ...
        from app.common.db.dynamo.moderation import (
            Report,
            ReportRepository,
            Vote,
            VoteRepository,
        )
        from app.common.db.dynamo.part_price_alerts import PartPriceAlert, PartPriceAlertRepository
    ...
    def test_the_replay_against_real_repositories_writes_nothing(self, dynamo_tables: Any) -> None:
        ...
        from app.common.db.dynamo.build_lists import BuildListPartRepository
        from app.common.db.dynamo.moderation import (
            Report,
            ReportRepository,
            Vote,
...
class TestEntrypoint:
    ...
    def client(monkeypatch: pytest.MonkeyPatch, repos: Any, sqs: Any) -> Any:
        ...
        from app.domains.catalog.consumers import part_purge_entrypoint as entrypoint
    ...
    def test_the_bundle_carries_the_four_cascade_tables_and_nothing_else(self) -> None:
        ...
        """
        from app.domains.catalog.consumers.part_purge_entrypoint import REPOSITORIES
