...
from app.domains.admin.schemas.part_price_alert import PartPriceAlertCreate, PartPriceAlertRead, PartPriceAlertUpdate
from app.domains.admin.services import part_price_alert_service as service
