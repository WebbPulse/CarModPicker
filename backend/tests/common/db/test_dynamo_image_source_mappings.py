...
from app.common.db.dynamo.image_source_mappings import SOURCE_URL_INDEX, ImageSourceMappingRepository
from app.common.db.dynamo.tables import IMAGE_SOURCE_MAPPINGS
