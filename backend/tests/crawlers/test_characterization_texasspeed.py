"""SAFE-07 characterization for TexasSpeedAdapter.
...
FIXTURE_DIR = Path(__file__).parent / "fixtures" / "texasspeed"
...
def test_parse_product_page_matches_expected() -> None:
    ...
    adapter = ADAPTER_REGISTRY["texasspeed"]()
...
#   FIXTURE = Path('tests/crawlers/fixtures/texasspeed')
#   html = (FIXTURE/'product.html').read_text()
#   expected = json.loads((FIXTURE/'expected.json').read_text())
#   payload = TexasSpeedAdapter().parse_product_page(html, expected['product_url'])
