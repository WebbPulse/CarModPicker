"""SAFE-07 characterization for SubispeedAdapter.
...
#   FIXTURE = Path('tests/crawlers/fixtures/subispeed')
#   html = (FIXTURE/'product.html').read_text()
#   expected = json.loads((FIXTURE/'expected.json').read_text())
#   payload = SubispeedAdapter().parse_product_page(html, expected['product_url'])
