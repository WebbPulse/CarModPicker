...
shim (on a branch where the big dict literal still exists), because the
CAR_GENERATIONS import has to resolve the pre-shim dict literal. For Phase 3,
...
def main() -> int:
    """Write CAR_GENERATIONS to the JSON file and return 0."""
    TARGET.write_text(
