...
from app.common.api.schemas.part import (
    MAX_IMAGES_PER_PART,
    PartAppendImages,
    PartCreate,
    PartRead,
...
from app.common.api.schemas.part_listing import PartListingCreate, PartListingReadWithRetailer
from app.common.api.schemas.part_price_history import (
...
from app.common.api.services.part_service import PartListFilters, PartService, purge_related_rows_for_parts
from app.common.api.utils.authorization import require_part_edit_permission
from app.common.api.utils.base_dynamo_endpoint_router import BaseDynamoEndpointRouter
from app.common.api.utils.common_patterns import PublicEndpointDeps, get_standard_public_endpoint_dependencies
from app.common.api.utils.cursor_pagination import CursorParams, get_cursor_params
from app.common.api.utils.endpoint_decorators import pagination_responses, standard_responses
...
async def remove_image_from_part(
    ...
    from app.common.api.services.storage_service import storage_service
    from app.common.api.utils.image_utils import is_file_key
