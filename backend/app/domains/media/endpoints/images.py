...
from app.domains.media.utils.bucket_orphan_utils import get_all_referenced_file_keys
from app.domains.media.utils.image_url_utils import get_canonical_image_url, get_high_res_image_url
from app.domains.media.utils.remote_image_fetch import assert_url_is_fetchable, fetch_remote_image
...
def _authorize_image_target(
    ...
    if entity_type == "part":
        from app.common.api.schemas.part import MAX_IMAGES_PER_PART
