...
CATEGORY_KEYWORDS: dict[str, list[str]] = {
    "exhaust": [
        "exhaust", "muffler", "header", "headers", "downpipe", "down pipe",
        "cat-back", "catback", "axle-back", "axle back", "midpipe", "mid pipe",
        "tip", "exhaust tip", "resonator", "y-pipe", "x-pipe", "turbo back",
    ],
    "suspension": [
        "coilover", "coil over", "coil-over", "spring", "springs", "strut", "struts",
        "shock", "shocks", "sway bar", "swaybar", "stabilizer", "control arm",
        "camber", "lowering", "lowered", "bushing", "end link", "tie rod",
    ],
    "engine": [
        "turbo", "turbocharger", "supercharger", "intake", "cold air", "cai",
        "intercooler", "blow-off", "bov", "wastegate", "tune", "ecu", "piggyback",
        "downpipe", "header", "injector", "fuel pump", "oil cooler", "radiator",
    ],
    "wheels": [
        "wheel", "wheels", "rim", "rims", "tire", "tires", "tyre", "tyres",
        "lug", "lug nut", "hub", "hubcentric", "spacer", "center cap",
        "gram lights", "volk", "te37", "work", "enkei", "bbs", "rotiform",
    ],
    "body": [
        "body kit", "bodykit", "spoiler", "wing", "splitter", "lip", "diffuser",
        "bumper", "fender", "hood", "aero", "aerodynamic", "side skirt",
        "widebody", "wide body", "grille", "grill", "carbon fiber", "cf ",
    ],
    "interior": [
        "seat", "seats", "steering wheel", "steering wheels", "shift knob", "shifter",
        "shift paddle", "shift paddles", "paddle shift",
        "harness", "roll bar", "rollbar", "cage", "floor mat", "pedal",
        "gauge", "cluster", "interior", "trim", "alcantara", "bucket seat",
    ],
    "brakes": [
        "brake", "brakes", "pad", "pads", "rotor", "rotors", "caliper", "calipers",
        "brake line", "brakeline", "brake fluid", "bbk", "big brake", "slotted",
        "drilled", "stainless line", "brake kit",
    ],
    "lighting": [
        "headlight", "headlights", "headlamp", "taillight", "taillights", "tail light",
        "tail lamp", "fog light", "fog lights", "fog lamp", "drl", "daytime running",
        "led", "hid", "light bar", "lightbar", "turn signal", "marker light",
        "lighting", "lamp", "bulb", "halo", "angel eye", "grille light",
    ],
    "drivetrain": [
        "differential", "diff", "diffs", "driveshaft", "drive shaft", "axle", "axles",
        "clutch", "flywheel", "transmission", "trans", "shaft", "cv joint",
        "driveline", "prop shaft", "half shaft", "lsd", "locker",
    ],
}
