...
from app.common.db.dynamo.build_lists import BuildList as DBBuildList
from app.common.db.dynamo.catalog import CarGeneration, Part
from app.common.db.dynamo.moderation import DOWNVOTE, Vote
